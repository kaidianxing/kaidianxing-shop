...
/**
 * This is the model class for table "{{%notice_wechat_subscribe_template}}".
 *
 * @property int $id
 ...
 */
class NoticeWechatSubscribeTemplateModel extends BaseActiveRecord
{
    ...
    {
        return '{{%notice_wechat_subscribe_template}}';
    }
