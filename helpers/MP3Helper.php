...
class MP3Helper
{
    ...
    public static function formatTime($duration): array //as hh:mm:ss
    {
    ...
    public function getDuration($use_cbr_estimate=false)
    {
        ...
        while (!feof($fd))
        {
            ...
            else if ($block[0]=="\xff" && (ord($block[1])&0xe0) )
            {
                ...
                if(empty($info['Sampling Rate'] )){
                    $info['Sampling Rate']  = 1;
                }
