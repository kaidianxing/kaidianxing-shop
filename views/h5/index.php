<!DOCTYPE html><html lang="zh-CN"><head><meta charset="utf-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><title></title><script>document.addEventListener('DOMContentLoaded', function () {
    ...
    <script>window.config = <?php echo $settingsJson ?? ''?>;
        ...
        .app-loading-skeleten .goods .good-info::after {
            ...
            height: 3vw;
            border-radius: 0.6vw;
        }</style><div class="app-loading-skeleten"><div class="search"></div><div class="swiper"><div class="dots"><p></p><p></p><p></p><p style="background:#fff"></p></div></div><div class="btns"><p class="btn"></p><p class="btn"></p><p class="btn"></p><p class="btn"></p><p class="btn"></p><p class="btn"></p><p class="btn"></p><p class="btn"></p><p class="btn"></p><p class="btn"></p></div><div class="title"></div><div class="goods"><p class="good"></p><p class="good"></p><p class="good-info"></p><p class="good-info"></p></div></div></div><script src="/static/dist/shop_wap/static/js/chunk-vendors.js?v=1.0.2"></script><script src="/static/dist/shop_wap/static/js/index.js?v=1.0.2"></script></body></html>