...
class AmapClient
{
     ...
     * @author 青岛开店星信息技术有限公司
     */
    protected static function getApiKey($shopType)
    {
     ...
     * @author likexin
     */
    public static function getLocation(string $address, int $shopType)
    {
        //过滤地址信息的空格
     ...
     * @author 青岛开店星信息技术有限公司
     */
    public static function getLocationPoint( string $address, int $shopType)
    {
        $locationArray = self::getLocation( $address, $shopType);
     ...
     * @param int $shopType 单店铺/多商户
     * @return array|mixed|null
     * @author 青岛开店星信息技术有限公司
     */
    public static function getActualDistance(string $startLocation, string $destinationLocation, int $shopType = 0)
    {
        // 请求数据
     ...
     * @author 青岛开店星信息技术有限公司
     */
    public static function getDirectionBicycling(string $origin, string $destination, int $shopType)
    {
        // 请求数据
     ...
     * @author 青岛开店星信息技术有限公司
     */
    public static function getAddressByLngAndLat(string $startLocation, int $shopType = 0)
    {
