...
class MiniProgramShortLinkHelper
{
    /**
     * 获取小程序短链
     * @param array $data
    ...
    public static function generate(array $data)
    {
        try {
            ...
            $result = HttpHelper::postJson('https://api.weixin.qq.com/wxa/genwxashortlink?access_token=' . $token['access_token'], Json::encode($data), [
                'headers' => [
