 ...
 * 领取记录
 * Class LogController
 * @package apps\shoppingReward\manage
 */
    ...
    public function actionList()
    {
        ...
        $params = [
            'searchs' => [
                ...
                [['member.id', 'member.nickname', 'member.mobile', 'member.realname'], 'like', 'member_keyword'],
            ],
            'select' => [
                'log.id',
                'log.member_id',
            ...
            'andWhere' => $andWhere,
            'leftJoins' => [
                [ShoppingRewardActivityModel::tableName().' activity', 'log.activity_id = activity.id'],
        ...
        $list = ShoppingRewardLogModel::getColl($params, [
